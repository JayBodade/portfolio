...
function App() {
  ...
  const showMenu = () => {
    const ele = document.getElementById('navforsmallwidth');
    ...
    <>
      <div className="App">
        <div className='maincontainer w-full h-fit border  fixed flex' >
          ...
          <div  ref={menuref} className="navcontainer w-80 h-fit absolute mt-6 hidden  ml-4 rounded-3xl bg-white shadow-black " id="navforsmallwidth">

<div className='w-full h-full py-8 px-6  text-lg '  >
    <nav className='navbar w-full h-fit  justify-center text-center'>
      <ul className=' font-mono text-sm ' style={{ fontSize: '20px' }} >
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3  ' onClick={hanldemenu}><a href="#home">HOME</a> </li>
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3' onClick={hanldemenu}><a href='#about'>ABOUT</a></li>
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3' onClick={hanldemenu}><a href='#education'>EDUCATION & SKIILS</a></li>
        {/* <li className='mt-5 mb-4 hover:cursor-pointer '><a href="#blog">BLOG</a> </li> */}
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3' onClick={hanldemenu}><a href="#project">PROJECTS</a> </li>
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3' onClick={downloadResume}>RESUME</li>
        <li className='mt-5 mb-4 hover:cursor-pointer pb-3' onClick={hanldemenu}><a href="#contact">CONTACT</a></li>
      </ul>
    </nav>
  </div>

</div>
            <div id="right-sidecontainer" className='rightside-container relative   w-full overflow-y-scroll   ' style={{ width: '', height: '800px', scrollBehavior: 'smooth' }} >
              <div className='rightcont w-96  shadow-sm ' style={{ width: '900px' }}>
                <div id="home" className='rightside-first-container bg-cyan -mt-9 w-full  ' style={{ height: '786px' }}>
                  <div id="home-image " alt="" className=' shadow-2xl' style={{
                    width: '110%', height: '100%', opacity: '0.87', backgroundImage: `url(${backgroundImagesHome[homeIndex]})`,
                  ...
                  <section id='education' className={`rigth-side-education-section fade-left-to-right ${eduElement ? 'animate' : ''} w-full h-fit  `}>
                    ...
                    <div className='education-rows mt-8 opacity-1 visible '>
                      <div className='flex flex-col'>
                        ...
                        <div id='btech' className={`education-row-content w-150 h-16 border flex border-white  bg-gray-200 mt-1 mb-1 fade-left-to-right ${eduElement ? 'animate' : ''} ml-2`}>
                    ...
                    <div className='skill-rows mt-8'>
                      <div>
                        ...
                        <div id='languagedropdown' className="dropdown-languages-container sizeContaine ml-2 border border-gray-300">
                          <div className='dropdown-skill-container-language flex w-full h-full  '>
                            <div className='flex w-full  m-auto ml-1 '> <img src={javaImage} alt="" width={'35px'} height={'35px'} /> <h1 className='mt-3'>JAVA</h1></div>
                            <div className='flex w-full  m-auto '> <img src={cppImage} alt="" width={'35px'} height={'35px'}  /> <h1 className='mt-2'>CPP</h1></div>
                            <div className='flex w-full  m-auto '> <img src={jsImage} alt="" width={'35px'} height={'35px'} /> <h1 className='mt-2'>JAVASCRIPT</h1></div>                            </div>
                        </div>
                      </div>
                      <div>
